...
public class blueBokoblin {
	...
	public void registerRenderers() {
		RenderBiped customRender = new RenderBiped(Minecraft.getMinecraft().getRenderManager(), new ModelBiped(), 0) {
			protected ResourceLocation getEntityTexture(Entity par1Entity) {
				return new ResourceLocation("bokoblin.png");
			}
		};
		...
		RenderingRegistry.registerEntityRenderingHandler(blueBokoblin.EntityblueBokoblin.class, customRender);
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		mobid = entityID;
		EntityRegistry.registerModEntity(new ResourceLocation("testzeldamobs:blueBokoblin"), blueBokoblin.EntityblueBokoblin.class,
				"blueBokoblin", entityID, instance, 64, 1, true, (0 << 16) + (0 << 8) + 153, (0 << 16) + (102 << 8) + 255);
		EntityRegistry.addSpawn(blueBokoblin.EntityblueBokoblin.class, 25, 1, 3, EnumCreatureType.MONSTER, clean(Biome.REGISTRY));
	...
	public static class EntityblueBokoblin extends EntityMob {
		World world = null;

		public EntityblueBokoblin(World var1) {
			super(var1);
			world = var1;
			experienceValue = 5;
