...
public class darknut {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		mobid = entityID;
		EntityRegistry.registerModEntity(new ResourceLocation("ZeldaMobs:darknut"), darknut.Entitydarknut.class, "darknut",
		...
		DungeonHooks.addDungeonMob(new ResourceLocation("ZeldaMobs:darknut"), 180);
	...
	public static class Entitydarknut extends EntityMob {
		...
		protected net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(
					"ZeldaMobs:entity.darknut.idle"));
		}

		@Override
		protected net.minecraft.util.SoundEvent getHurtSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(
					"ZeldaMobs:entity.darknut.hit"));
		}

		@Override
		protected net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(
					"ZeldaMobs:entity.darknut.death"));
		}
