...
public class braveShield {
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT)
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(block, 0, new ModelResourceLocation("testzeldamobs:BraveShield", "inventory"));
	}
	...
	static {
		block = (new ItembraveShield());

	}

	static class ItembraveShield extends Item {

		public ItembraveShield() {
			setMaxDamage(0);
			maxStackSize = 1;
			setUnlocalizedName("BraveShield");
			setRegistryName("BraveShield");
