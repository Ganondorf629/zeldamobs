...
public class mcreator_gibdo {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        EntityRegistry.addSpawn(Entitygibdo.class, (int)10, (int)1, (int)1, (EnumCreatureType)EnumCreatureType.MONSTER, (Biome[])mcreator_gibdo.clean(Biome.field_185377_q));
    }
    ...
    extends EntityMob {
        ...
        public Entitygibdo(World var1) {
            ...
            this.field_70714_bg.func_75776_a(6, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityDragon.class, 6.0f));
            this.field_70714_bg.func_75776_a(7, (EntityAIBase)new EntityAIAttackMelee((EntityCreature)this, 1.0, false));
            this.field_70715_bh.func_75776_a(8, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, EntityPlayer.class, true));
