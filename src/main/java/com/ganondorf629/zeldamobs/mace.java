...
public class mace {
	...
	public void load(FMLInitializationEvent event) {
		...
		if (event.getSide() == Side.CLIENT)
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(block, 0, new ModelResourceLocation("testzeldamobs:mace", "inventory"));
	}
	...
	static {
		Item.ToolMaterial enumt = EnumHelper.addToolMaterial("MACE", 1, 100, 5F, 9, 2);
