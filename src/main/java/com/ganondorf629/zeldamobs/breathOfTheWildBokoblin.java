...
public class breathOfTheWildBokoblin {
	...
	public void registerRenderers() {
		RenderBiped customRender = new RenderBiped(Minecraft.getMinecraft().getRenderManager(), new ModelBiped(), 0) {
			protected ResourceLocation getEntityTexture(Entity par1Entity) {
				return new ResourceLocation("bokoblin_breathofthewild.png");
			}
		};
		...
		RenderingRegistry.registerEntityRenderingHandler(breathOfTheWildBokoblin.EntitybreathOfTheWildBokoblin.class, customRender);
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		mobid = entityID;
		EntityRegistry.registerModEntity(new ResourceLocation("testzeldamobs:breathOfTheWildBokoblin"),
				breathOfTheWildBokoblin.EntitybreathOfTheWildBokoblin.class, "breathOfTheWildBokoblin", entityID, instance, 64, 1, true,
				(204 << 16) + (102 << 8) + 0, (255 << 16) + (153 << 8) + 0);
		EntityRegistry.addSpawn(breathOfTheWildBokoblin.EntitybreathOfTheWildBokoblin.class, 50, 3, 3, EnumCreatureType.MONSTER,
				clean(Biome.REGISTRY));
	...
	public static class EntitybreathOfTheWildBokoblin extends EntityMob {
		World world = null;

		public EntitybreathOfTheWildBokoblin(World var1) {
			super(var1);
			world = var1;
			experienceValue = 5;
		...
		protected net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(
					"testzeldamobs:entity.bokoblin.attack"));
		}

		@Override
		protected net.minecraft.util.SoundEvent getHurtSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(
					"testzeldamobs:entity.bokoblin.hit"));
		}

		@Override
		protected net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(
					"testzeldamobs:entity.bokoblin.death"));
		}
